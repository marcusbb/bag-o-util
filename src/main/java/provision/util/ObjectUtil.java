...
/**
 * This class consists of {@code static} utility methods for operating on objects. These utilities include {@code null}-safe or {@code null}-tolerant methods
 * for computing the hash code of an object, returning a string for an object, and comparing two objects.
 * 
 * <br>
 * Inspired from the java.util.Objecs in Java 7.0
 */
public final class ObjectUtil {
	 ...
	 * 
	 * <p>
	 * Note that if one of the arguments is {@code null}, a {@code NullPointerException} may or may not be thrown depending on what ordering policy, if any, the
	 * {@link Comparator Comparator} chooses to have for {@code null} values.
	 * 
